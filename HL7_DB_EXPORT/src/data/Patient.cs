...
public class CodeableConcept {
  private StringArray coding;
  private StringArray text;
  public CodeableConcept( StringArray _coding,  StringArray _text) {
    this.coding = _coding;
    this.text = _text;
  }
  public StringArray getCoding() {
    return coding;
  }
  public void setCoding(StringArray _v) {
    coding = _v;
  }
...
public class Patient {
  ...
  private Organizations careProvider;
  private Organizations managingOrganization;
  private BoolArray active;
  private Links link;
  public Patient( Identifiers _identifier,  HumanNames _name,  ContactPoints _telecom,  StringArray _gender,  StringArray _birthData,  Addresses _address,  Attachments _photo,  Organizations _careProvider,  Organizations _managingOrganization,  BoolArray _active,  Links _link) {
  ...
  public Organizations getCareProvider() {
    return careProvider;
  }
  public void setCareProvider(Organizations _v) {
    careProvider = _v;
  }
